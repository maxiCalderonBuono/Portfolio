...
const Contact = () => {
  return (
    <section className="relative flex flex-col min-h-[calc(100vh-72px)] max-h-[calc(100vh-72px)] items-center justify-end gap-5 max-w-full  mx-auto bg-gradient-to-b from-[#28044d] to-[#0E001C]">
